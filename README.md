...
```
> curl -XPOST -H "Content-Type: application/json" localhost:9000/com.lightbend.gsa.parentalcontrol.childdevice.MyServiceEntity/GetValue -d '{"entityId": "foo"}'
...
```
> grpcurl -plaintext -d '{"entityId": "foo"}' localhost:9000 com.lightbend.gsa.parentalcontrol.childdevice.MyServiceEntity/GetValue
ERROR:
  Code: Unknown
...
# as-parental-control-child-device-java
